...
def analyze_html_file(file_path: str) -> SchemaAnalysis:
    ...
    # WebApplication is intentionally NOT flagged as missing — it is only appropriate
    # for actual tool/calculator pages, not service or content sites.  Having it on a
    # service site with offers.price="0" triggers Rich Result validation errors.
